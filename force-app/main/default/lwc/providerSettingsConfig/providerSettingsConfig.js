...
export default class ProviderSettingsList extends LightningElement {
    ...
    get isTwilioWhatsApp() {
        return this.providerSettings.channel == 'Twilio_WhatsApp';
    }
    ...
    channelOptions = [
		...
		wiredSettings(result) {
				...
				if (result.data) {
                        ...
                        let twilio_WhatsAppRec = providerSettingList.find(record => record.channel == 'Twilio_WhatsApp');
						if(!smsRec){
                        ...
                        if(!twilio_WhatsAppRec){
								this.providerSettingList = [...this.providerSettingList,twilio_WhatsApp];
						} else {
								this.providerSettingList = [...this.providerSettingList,twilio_WhatsAppRec];
						}
